	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
                $con = dbcon();
								$query = mysqli_query($con,"select * from admin where admin_id = '$get_id'")or die(mysqli_error());
...
mysqli_query($con,"update admin set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where admin_id = '$get_id' ")or die(mysqli_error());
mysqli_query($con,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit system User $firstname')")or die(mysqli_error());	
?>
<script>
