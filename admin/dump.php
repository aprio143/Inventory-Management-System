...
<?php 
mysqli_query($con,"update stdevice set dev_status='Dump' where id = '$get_id'")or die(mysqli_error());
mysqli_query($con,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Dump Device $dev_name Inventory Code:$dev_serial')")or die(mysqli_error());						
