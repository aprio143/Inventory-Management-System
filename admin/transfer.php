				...
				<?php include('device_location_slidebar.php'); ?>
						...
						<div class="span9" id="content">
                          ...
                          <div class="empty">
						    ...
						    <?php $location_query = mysqli_query($con,"select * from stlocation
									   ...
									   <div class="control-group">
										...
										<div class="control-group">
		                                  <label class="control-label" for="inputEmail">Move TO</label>
				                            ...
				                            <option></option>
			                                 <?php $result =  mysqli_query($con,"select * from stlocation")or die(mysqli_error()); 
										...
										mysqli_query($con,"update location_details set
										            date_deployment = '$ora',
													stdev_id = '$stdev_id'													
													where id = '$get_id' ")or die(mysqli_error());
													
										mysqli_query($con,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','transfer Device  $dev_name to location id $stdev_id')")or die(mysqli_error());			
										?>
										<script>
