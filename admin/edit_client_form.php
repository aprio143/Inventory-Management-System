	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
                $con = dbcon();
								$query = mysqli_query($con,"select * from client where client_id = '$get_id'")or die(mysqli_error());
...
mysqli_query($con,"update client set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where client_id = '$get_id' ")or die(mysqli_error());

mysqli_query($con,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit Client User $firstname')")or die(mysqli_error());	
?>
<script>
