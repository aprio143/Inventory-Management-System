				  ...
				  <img id="admin_avatar" class="img-polaroid" src="<?php echo $row['adminthumbnails']; ?>"></div>
                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li class="active">						
							...
							<?php $con = dbcon(); if($not_read_new == '0'){
				            }else{ ?>
					  ...
					  <!------/.* manage DKGAC user sidebar*------->	
						<li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs2"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Manage DKGAC User
							<div class="muted pull-right"><i class="caret"></i></div></a>					
