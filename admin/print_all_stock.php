...
"Times New Roman","serif"'>DKGAC all Stock<o:p></o:p></span></p>
...
<?php
    $con = dbcon();
		$device_query = mysqli_query($con,"select * from stdevice 
...
<?php	
	           $count_item=mysqli_query($con,"select * from stdevice 
...
?>
 <tr style='mso-yfti-irow:1;height:17.85pt'>
  ...
  <p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b style='mso-bidi-font-weight:normal'><u><span
  style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:"Times New Roman","serif"'>MR.KALAI
  <o:p></o:p></span></u></b></p>
  </td>
  <td width=376 valign=top style='width:281.85pt;padding:0in 5.4pt 0in 5.4pt;
  height:17.85pt'>
