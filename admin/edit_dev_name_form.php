	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
                $con = dbcon();
								$query = mysqli_query($con,"select * from device_name where dev_id = '$get_id'")or die(mysqli_error());
...
mysqli_query($con,"update device_name set dev_name = '$dev_name'  where dev_id = '$get_id' ")or die(mysqli_error());

mysqli_query($con,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit Device Type $dev_name')")or die(mysqli_error());	
?>
<script>
