			 ...
			 <?php include('dashboard_slidebar.php'); ?>		
                <div class="span9" id="content">
                    <div class="row-fluid">
         	         <?php 
					 $con = dbcon();
					 $query= mysqli_query($con,"select * from admin where admin_id = '$session_id'")or die(mysqli_error());
                    ...
                    <div class="col-lg-12">
                      <div class="alert alert-success alert-dismissable">
                        ...
                        <div id="block_bg" class="block">
                           ...
                           <?php 
								$stocks = mysqli_query($con,"select * from stdevice
								...
								<?php 
								$new = mysqli_query($con,"select * from stdevice 
								...
								<?php 
								$damage = mysqli_query($con,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								<?php 
								$device_location = mysqli_query($con,"select * from location_details")or die(mysqli_error());
								...
								<?php 
								$keyboard = mysqli_query($con,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								<?php 
								$Mouse = mysqli_query($con,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								<?php 
								$Monitor = mysqli_query($con,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								<?php 
								$CPU = mysqli_query($con,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								<?php 
								$power_supply = mysqli_query($con,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								<?php 
								$vga = mysqli_query($con,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								<?php 
								$power_cords = mysqli_query($con,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
