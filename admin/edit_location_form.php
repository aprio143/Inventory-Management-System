	               ...
	               <script type="text/javascript">
		              ...
		              $('#add').tooltip('hide');
                        ...
                        <div class="block">
							...
							<?php
                            $con = dbcon();
							$query = mysqli_query($con,"select * from stlocation where stdev_id = '$get_id'")or die(mysqli_error());
...
mysqli_query($con,"update stlocation set stdev_location_name = '$stdev_location_name' where stdev_id = '$get_id' ")or die(mysqli_error());

mysqli_query($con,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit location $stdev_location_name')")or die(mysqli_error());
?>
