...
<head>
    ...
    <meta name="description" content="Dr.KALAGNAR ARTS COLLEGE KULITHALAI (DKACK)">
    <meta name="author" content="PRATHAP">

<link rel="shortcut icon" href="admin/images/logo.png" style="width: 200px" />
                     ...
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<hr>
										<?php
											$vision_query = mysqli_query($con,"SELECT * from content where title  = 'vision' ")or die(mysqli_error());
