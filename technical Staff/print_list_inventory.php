...
<?php 
 $con = dbcon();
 $location_query = mysqli_query($con,"select * from stlocation	                     
...
src="print-list-inventory_files/image001.png" style="width: 200px"></span></b></p>

<p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:14.0pt;
font-family:"Times New Roman","serif"'>Dr.KALAIGNAR ARTS COLLEGE KULITHALAI (DKGAC)</span></b></p>

<p class=MsoNormal align=center style='margin-bottom:0in;margin-bottom:.0001pt;
text-align:center;line-height:normal'><b><span style='font-size:8.0pt;
font-family:"Times New Roman","serif"'>Powered by Code Warrior</span></b></p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <?php
$my_device = mysqli_query($con,"select * from location_details	                                                    
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:2'>
  ...
  <?php	
	          $my_keyboard = mysqli_query($con,"select * from location_details    
	          LEFT JOIN stdevice ON location_details.id = stdevice.id
			  LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			  where NOT EXISTS 
             (select * from location_details where dev_status='Dump')
 ...
 <?php
$new = mysqli_query($con,"select * from location_details	                                                    
LEFT JOIN stdevice ON location_details.id = stdevice.id 
LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
...
?>
 ...
 <?php	
	            $my_mouse = mysqli_query($con,"select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
...
?>   
 ...
 <?php	
	            $my_monitor = mysqli_query($con,"select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
...
<?php	
	            $my_cpu = mysqli_query($con,"select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump') 
...
?>
 ...
 <?php	
	            $my_power_supply = mysqli_query($con,"select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
...
?>	
 ...
 <?php	
	            $my_vga = mysqli_query($con,"select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
...
?>	
 ...
 <?php	
	            $my_avr = mysqli_query($con,"select * from location_details    
	            LEFT JOIN stdevice ON location_details.id = stdevice.id
				LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
				where NOT EXISTS 
                (select * from location_details where dev_status='Dump')
...
<?php $query= mysqli_query($con,"select * from client where client_id = '$session_id'")or die(mysqli_error());
