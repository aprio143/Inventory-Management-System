					 ...
					 <a href="device_location.php" class="btn btn-info"  id="return" data-placement="right" title="Click to return" ><i class="icon-arrow-left icon-large"></i> Back</a>
		              ...
		              $('#return').tooltip('hide');
					   ...
					   <!-----------------------------------sc logo for print------------------------------------>	
						...
						<?php $con = dbcon(); $location_query = mysqli_query($con,"select * from stlocation	                     
...
<tr>
		<td><?php
			   $device_query2 = mysqli_query($con,"select * from stdevice ")or die(mysqli_error());
			...
			<td><?php
			   $my_device1 = mysqli_query($con,"select * from stdevice ")or die(mysqli_error());
