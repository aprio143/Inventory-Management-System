            ...
            <div class="row-fluid">
				<?php include('client_sidebar.php'); ?>	
                   <div class="span9" id="content">
                      <div class="row-fluid">
					     <?php $con = dbcon(); $query= mysqli_query($con,"select * from client where client_id = '$session_id'")or die(mysqli_error());
                        ...
                        <div id="block_bg" class="block">
				           ...
				           <div class="span12">
					           ...
					           <?php 
								...
								<?php 
								$device_location = mysqli_query($con,"select * from stlocation")or die(mysqli_error());
