			                                ...
			                                <div class="controls">
				                              <select name="dev_id" class="chzn-select"  required/>
				                                 <option></option>
			                                       <?php 
			                                       $con = dbcon();
			                                       $device_name =  mysqli_query($con,"select * from device_name")or die(mysqli_error()); 
...
mysqli_query($con,"insert into stdevice (dev_id,dev_desc,dev_serial,dev_brand,dev_model,dev_status) values('$dev_id','$dev_desc','$dev_serial','$dev_brand','$dev_model','$dev_status')")or die(mysqli_error());
mysqli_query($con,"insert into notification (fullname,notification,date_of_notification,link) value('$client_fullname','Add device id $dev_id, Serial Number: $dev_serial',NOW(),'device_stocks.php')")or die(mysqli_error());										
?>
<script>
window.location = "device_stocks.php";
