...
<html class="no-js">
    <head>
        <title>Dr.KALAIGNAR ARTS COLLEGE KULITHALAI (DKGAC)</title>
		<meta name="description" content="Dr.KALAIGNAR ARTS COLLEGE KULITHALAI (DKGAC)">
		<meta name="keywords" content="">
		<meta name="author" content="Jonald Remus Sevellejo">
		<meta charset="UTF-8">
        <!-- Bootstrap -->
		<link href="css/my_style.css" rel="stylesheet">			
		<link href="../images/logo.png" rel="icon" type="image" style="width: 200px">		
